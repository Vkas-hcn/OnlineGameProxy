 ...
 */
class BD(
    private val service: Z.Interface, profileName: String,
...
//        .setContentIntent(V.configureIntent(service))
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (service.data.state == Z.State.Connected) updateCallback(intent.action == Intent.ACTION_SCREEN_ON)
    }
