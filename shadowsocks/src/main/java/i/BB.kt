...
class BB(private val resolver: suspend (ByteArray) -> ByteArray) : ConcurrentLocalSocketListener(
        "LocalDnsThread", File(V.deviceStorage.noBackupFilesDir, "local_dns_path")), CoroutineScope {
