package com.vkas.onlinegameproxy.widget
...
import com.vkas.onlinegameproxy.widget.HorizontalProgressViewOg.AnimateType
...
class HorizontalProgressViewOg @JvmOverloads constructor(
    context: Context,
    ...
    private fun drawProgressText(canvas: Canvas) {
        if (textVisibility) {
            ...
            mRingPaint.color =
                context.resources.getColor(com.vkas.onlinegameproxy.R.color.outer_side_of_ring)
    ...
    fun startProgressAnimation() {
        ...
        progressAnimator?.addListener(object : Animator.AnimatorListener {
            override fun onAnimationStart(animator: Animator) {
                if (animatorUpdateListener != null) {
                    animatorUpdateListener!!.onHorizontalProgressStart(this@HorizontalProgressViewOg)
                }
            }

            override fun onAnimationEnd(animator: Animator) {
                if (animatorUpdateListener != null) {
                    animatorUpdateListener!!.onHorizontalProgressFinished(this@HorizontalProgressViewOg)
                }
            }
