...
class ResultActivity : BaseActivity<ActivityResultOgBinding, BaseViewModel>()  {
    ...
    override fun initData() {
        ...
        binding.imgCountry.setImageResource(OnlineGameUtils.getFlagThroughCountryEc(currentServerBeanOg.og_country.toString()))
...
//        }
    ...
    private fun displayTimer() {
        LiveEventBus
            ...
            .observeForever {
                KLog.e("TAG","isConnectionOg=$isConnectionOg---->${mmkvOg.decodeString(Constant.LAST_TIME, "")}")
                if(it != "00:00:00"){
                    if (isConnectionOg) {
